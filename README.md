Git Commands to learn Git 
git init ( initialised git in that folder , which we wants to push on github )
git add . # ( add the changes on github that we have do )
git status # ( This command use to check status and changes we have to in which files )
